...
namespace RacketSpeed.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = DataConstants.RequiredFieldErrorMessage)]
            [StringLength(100, ErrorMessage = "Паролата трябва да съдържа между 6 и 100 символа.", MinimumLength = 6)]
        ...
        public IActionResult OnGet(string code = null)
        {
            if (code == null)
            {
                return BadRequest("Нужен е токен за да се промени паролата.");
            }
            else
            {
